...
This readme file is still not completed. So, if you need any help in using these codes please feel free to email me.
email: nalinda05kl@gmail.com

Note: Input file should contain the <q(r,s)> TProfile histograms as the input for these set of codes to generate the output.
